...
def parse_chess_move(chess: Game):
    """
...
def handle_move_text(chess: Game):
    """
...
def fetch_chess_move_from_file(chess: Game):
    """
...
def handle_player_move_from_inputfile(chess: Game,
