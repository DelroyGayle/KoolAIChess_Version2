...
class File:
    ...
    FILE_C = {2, 10, 18, 26, 34, 42, 50, 58}
    FILE_D = {3, 11, 19, 27, 35, 43, 51, 59}
    FILE_E = {4, 12, 20, 28, 36, 44, 52, 60}
    FILE_F = {5, 13, 21, 29, 37, 45, 53, 61}
    ...
    THE_FILES = (FILE_A, FILE_B, FILE_C, FILE_D,
...
class Rank:
    RANK_X1 = {0, 1, 2, 3, 4, 5, 6, 7}
    RANK_X2 = {8, 9, 10, 11, 12, 13, 14, 15}
    RANK_X3 = {16, 17, 18, 19, 20, 21, 22, 23}
    RANK_X4 = {24, 25, 26, 27, 28, 29, 30, 31}
    RANK_X5 = {32, 33, 34, 35, 36, 37, 38, 39}
    RANK_X6 = {40, 41, 42, 43, 44, 45, 46, 47}
    RANK_X7 = {48, 49, 50, 51, 52, 53, 54, 55}
    RANK_X8 = {56, 57, 58, 59, 60, 61, 62, 63}
    ...
    THE_RANKS = (RANK_X1, RANK_X2, RANK_X3, RANK_X4,
                 RANK_X5, RANK_X6, RANK_X7, RANK_X8)
